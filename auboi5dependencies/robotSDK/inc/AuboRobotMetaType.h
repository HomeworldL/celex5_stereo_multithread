 ...
 *
 * 使用说明：
 * 　　1:当coordType==BaseCoordinate　下面3个参数(methods,wayPointArray,toolDesc)系统不做处理，
...
typedef enum
{
    ...
    ErrCode_moveControlSlowStopFailed,
    ErrCode_moveControlFastStopFailed,
    ErrCode_moveControlPauseFailed,
    ErrCode_moveControlContinueFailed,
